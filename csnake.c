 ...
 * is insanely ineffective,
 * and not optimal. Feel
 * free to improve!
*/
...
/* Roll die using stdlib.rand() */
int rollDie() { return rand() % 6 + 1; }   

/* Player initialization */
int player1 = 0, player2 = 0; 

/* Control and visualization of the board */
void printBoard() { 
    int board[101]; 
    for (int i = 1; i <= 100; i++) { 
        board[i] = i; 
...
/* Entry point to strap all of this together. */
int main() { 
    srand(time(0));
    int currentPlayer = 1; 
    int won = 0; 
